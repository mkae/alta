...
bool rational_fitter_parsec_one::fit_data(const vertical_segment* d, int np, int nq, rational_function* r)
{
...
bool rational_fitter_parsec_one::fit_data(const vertical_segment* d, int np, int nq, int ny, rational_function_1d* r)
{
    // Size of the problem
    const int N = np+nq ;
    const int M = d->size() ;
