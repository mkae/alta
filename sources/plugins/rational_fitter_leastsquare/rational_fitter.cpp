...
bool rational_fitter_leastsquare::fit_data(const rational_data* d, int np, int nq, rational_function* r) 
{
...
bool rational_fitter_leastsquare::fit_data(const rational_data* d, int np, int nq, int ny, rational_function* r) 
{
